...
\usepackage{float}
% HereWekeep the left and right margins equal. You can choose to have unequal margins if you want a two-sided book effect.
\usepackage[
	top    = 1.5cm,
	bottom = 1.80cm,
	left   = 2.00cm,
...
% Stylistic note:Weuse `\\` at the end of every paragraph to give some space between two paragraphs becauseWethink it looks neater. You can change the inter-paragraph spacing by using 
